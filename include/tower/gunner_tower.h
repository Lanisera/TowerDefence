...
public:
	GunnerTower()
	{
		...
		anim_idle_up.set_frame_date(tex_gunner, 4, 8, idx_list_idle_up);
		anim_idle_down.set_frame_date(tex_gunner, 4, 8, idx_list_idle_down);
		anim_idle_left.set_frame_date(tex_gunner, 4, 8, idx_list_idle_left);
		anim_idle_right.set_frame_date(tex_gunner, 4, 8, idx_list_idle_right);
		anim_fire_up.set_frame_date(tex_gunner, 4, 8, idx_list_fire_up);
		anim_fire_down.set_frame_date(tex_gunner, 4, 8, idx_list_fire_down);
		anim_fire_left.set_frame_date(tex_gunner, 4, 8, idx_list_fire_left);
		anim_fire_right.set_frame_date(tex_gunner, 4, 8, idx_list_fire_right);
