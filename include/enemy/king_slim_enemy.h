...
public:
	KingSlimEnemy()
	{
		...
		anim_sketch_up.set_frame_date(king_slime_sketch_texture, 6, 4, idx_up);
		anim_sketch_down.set_loop(true);
		anim_sketch_down.set_interval(0.1);
		anim_sketch_down.set_frame_date(king_slime_sketch_texture, 6, 4, idx_down);
		anim_sketch_left.set_loop(true);
		anim_sketch_left.set_interval(0.1);
		anim_sketch_left.set_frame_date(king_slime_sketch_texture, 6, 4, idx_left);
		anim_sketch_right.set_loop(true);
		anim_sketch_right.set_interval(0.1);
		anim_sketch_right.set_frame_date(king_slime_sketch_texture, 6, 4, idx_right);
